...
# yolov6注释
os.chdir(r"/home/yr/yr/code/object-detection/yolov6_all/YOLOv6_chinese_comment")

def get_args_parser(add_help=True):
    parser = argparse.ArgumentParser(description='YOLOv6 PyTorch Training', add_help=add_help)
    parser.add_argument('--data-path', default='./data/voc.yaml', type=str, help='path of dataset')  #
